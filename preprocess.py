...
preprocess.py --srcfile src_train.txt --targetfile tgt_train.txt --srcvalfile src_test.txt --targetvalfile tgt_test.txt --outputfile lcsts-char
"""
...
def main(arguments):
    ...
    parser.add_argument('--batchsize', help="Size of each minibatch.", type=int, default=256)
    parser.add_argument('--seqlength', help="Maximum sequence length. Sequences longer "
                                               "than this are dropped.", type=int, default=152)
